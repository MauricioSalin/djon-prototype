    ...
    <>
      ...
      <section id="showcase" className="relative py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6">
                <span className="bg-[#AFFF00] text-[#121212] px-4 py-1.5 rounded-full font-black text-xs tracking-widest">
                  EVENTO OFICIAL
                </span>
              </div>
            </motion.div>
            ...
            >
              <div>
                <motion.span
                  className="text-[#121212]/50 text-xs tracking-wide inline-block font-bold"
                ...
                <h2 className="text-3xl md:text-5xl font-black text-[#121212] tracking-tighter mt-2 leading-[0.9]">
                  SHOWCASE
                </h2>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <motion.div
                    key={label}
                    className="flex items-center gap-2 bg-[#121212] rounded-xl px-4 py-3"
                    whileHover={{ y: -3, scale: 1.02 }}
                    transition={{ type: "spring" as const, stiffness: 400, damping: 17 }}
                  >
                    <Icon className="w-4 h-4 text-[#AFFF00]" />
          ...
          <motion.div
            className="relative mt-12 h-[320px] md:h-[500px] overflow-hidden bg-transparent"
      ...
      {/* TEAM SECTION */}
      <section id="time" className="relative py-16 bg-[#121212] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
          ...
          >
            <motion.span
              className="text-[#AFFF00] text-xs tracking-wide font-bold inline-block"
          ...
          >
            {teamMembers.map((member) => (
              <motion.div
                ...
                className="group relative bg-[#1a1a1a] rounded-2xl overflow-hidden cursor-pointer"
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-white/50 mt-1 leading-relaxed">{member.description}</p>
                </div>
                <motion.div
          ...
          <motion.div
            className="mt-14 h-[260px] md:h-[420px] bg-transparent"
            initial={{ opacity: 0, y: 32 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 0.7, ease: [0.25, 0.4, 0.25, 1] as const }}
