// Social brand icons — SoundCloud SVG from theSVG.org (soundcloud trademark applies)

export function SoundCloudIcon({ size = 16, className = "" }: { size?: number; className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 75 33.51"
      width={size}
      height={size * (33.51 / 75)}
      className={className}
